...
class NDWI(L3_Algorithm):
    ...
    def process_data(self, input, l2_datacube: Optional[xr.Dataset] = None) -> List[L3_result]:
        ...
        ndwi_debug = ndwi.isel(t=0).values
        ...
        result = [L3_result(debug_image=ndwi_debug_img, algorithm_results=ndwi, time_indices=list(self.time_indices), result_type="datacube")]
        return result
