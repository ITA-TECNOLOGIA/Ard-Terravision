...
class NDTI(L1_Input):
    ...
    def _read_datacube(self, start_date, end_date, time_indices=None):
        ...
        ds = (datacube_subset['B04'] - datacube_subset['B03']) / (datacube_subset['B04'] + datacube_subset['B03']).to_dataset(name="NDTI")
    ...
    def get_debug_image(self):
        ...
        ndti_debug = self.datacube[self.spectral_index].isel(t=time_index).values
