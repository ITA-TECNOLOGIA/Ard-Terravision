...
class NDDI(L1_Input):
    ...
    def _read_datacube(self, start_date, end_date, time_indices=None):
        ...
        ds = (datacube_subset['B12'] - datacube_subset['B02']) / (datacube_subset['B12'] + datacube_subset['B02']).to_dataset(name="NDDI")
    ...
    def get_debug_image(self):
        ...
        nddi_debug = self.datacube[self.spectral_index].isel(t=time_index).values
