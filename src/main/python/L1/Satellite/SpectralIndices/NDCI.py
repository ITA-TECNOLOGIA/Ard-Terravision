...
class NDCI(L1_Input):
    ...
    def _read_datacube(self, start_date, end_date):
        ...
        ds = (datacube_subset['B05'] - datacube_subset['B04']) / (datacube_subset['B05'] + datacube_subset['B04']).to_dataset(name="NDCI")
    ...
    def get_debug_image(self):
        ...
        ndci_debug = self.datacube[self.spectral_index].isel(t=time_index).values
